...
public class ExpenseChildCategory extends Model{
	...
	+ "FOREIGN KEY(" + COLUMN_EXPENSE_PARENT_CATEGORY_ID + ") REFERENCES "+ExpenseParentCategory.TABLE_EXPENSE_PARENT_CATEGORY+"("+ExpenseParentCategory.COLUMN_ID+")"
	+ ");";
	...
	public static void onUpgrade(SQLiteDatabase database, int oldVersion,
			int newVersion) {
		Log.w(ExpenseChildCategory.class.getName(), "Upgrading database from version "
