...
public class AccountTable extends Model{
	...
	private static final String DATABASE_CREATE = "create table " 
			...
			+ COLUMN_ACCOUNT_CATEGORY_NAME + " TEXT, "
			+ COLUMN_NAME + " TEXT," 
	...
	*/
	...
	private static void loadAccounts(final SQLiteDatabase database) {
        new Thread(new Runnable() {
            public void run() {
                try {
                	database.execSQL( " INSERT INTO " + TABLE_ACCOUNT + "("+COLUMN_NAME+","+COLUMN_ACCOUNT_CATEGORY_ID+","+COLUMN_ACCOUNT_CATEGORY_NAME+")"+ " VALUES(\"Other\",1,\"other\") ;");
                	
                	database.execSQL(" INSERT INTO " + TABLE_ACCOUNT + "("+COLUMN_NAME+","+COLUMN_ACCOUNT_CATEGORY_ID+","+COLUMN_ACCOUNT_CATEGORY_NAME+","+COLUMN_CREDIT_LIMIT+","+COLUMN_MONTHLY_PAYMENT+")"+ " VALUES(\"Chase freedom\",2,\"credit card\",300000,10000) ;");
                	database.execSQL( " INSERT INTO " + TABLE_ACCOUNT + "("+COLUMN_NAME+","+COLUMN_ACCOUNT_CATEGORY_ID+","+COLUMN_ACCOUNT_CATEGORY_NAME+","+COLUMN_CREDIT_LIMIT+","+COLUMN_MONTHLY_PAYMENT+")"+ " VALUES(\"Capital one\",2,\"credit card\",700000,20000) ;");
                	database.execSQL( " INSERT INTO " + TABLE_ACCOUNT + "("+COLUMN_NAME+","+COLUMN_ACCOUNT_CATEGORY_ID+","+COLUMN_ACCOUNT_CATEGORY_NAME+","+COLUMN_CREDIT_LIMIT+","+COLUMN_MONTHLY_PAYMENT+")"+ " VALUES(\"Citi preffered\",2,\"credit card\",1200000,15000) ;");
                	database.execSQL( " INSERT INTO " + TABLE_ACCOUNT + "("+COLUMN_NAME+","+COLUMN_ACCOUNT_CATEGORY_ID+","+COLUMN_ACCOUNT_CATEGORY_NAME+","+COLUMN_CREDIT_LIMIT+","+COLUMN_MONTHLY_PAYMENT+")"+ " VALUES(\"Chase\",3,\"debit card\",100000,30000) ;");
